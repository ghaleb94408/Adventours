...
exports.editTour = exports.deleteTour = exports.createTour = void 0;
...
var createTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, imagesData) {
    var result, imgUploadResult;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          return (0, _axios.default)({
            ...
            data: (0, _axios.formToJSON)(data)
          });
        case 3:
          result = _context.sent;
          _context.next = 6;
          return _axios.default.patch("http://127.0.0.1:8000/api/v1/tours/".concat(result.data.data.id), imagesData);
        case 6:
          imgUploadResult = _context.sent;
          if (result.data.status === 'Success') {
            (0, _alerts.showAlert)('success', 'Tour Created Successfully!');
            window.setTimeout(function () {
              location.assign("/tours/".concat(result.data.data.slug));
            }, 1000);
          }
          _context.next = 13;
          break;
...
var editTour = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data, imagesData, id) {
    var result, imgUploadResult;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8000/api/v1/tours/".concat(id),
            data: (0, _axios.formToJSON)(data)
          });
        case 3:
          result = _context2.sent;
          _context2.next = 6;
          return _axios.default.patch("http://127.0.0.1:8000/api/v1/tours/".concat(id), imagesData);
        case 6:
          imgUploadResult = _context2.sent;
          if (result.data.status === 'Success') {
            (0, _alerts.showAlert)('success', 'Tour Created Successfully!');
            window.setTimeout(function () {
              location.assign("/tours/".concat(result.data.data.slug));
  ...
  return function editTour(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
exports.editTour = editTour;
var deleteTour = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _axios.default.delete("http://127.0.0.1:8000/api/v1/tours/".concat(id));
        case 3:
          result = _context3.sent;
  ...
  return function deleteTour(_x6) {
    return _ref3.apply(this, arguments);
  };
}();
exports.deleteTour = deleteTour;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"manageBookings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateBooking = exports.crossBooking = exports.createBooking = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          result = _context.sent;
          if (result.data.status === 'Success') {
            (0, _alerts.showAlert)('success', 'Booking Created Successfully!');
            window.setTimeout(function () {
...
var crossBooking = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.delete("http://127.0.0.1:8000/api/v1/bookings/".concat(id));
        case 3:
          result = _context2.sent;
          if (result) (0, _alerts.showAlert)('success', 'Booking deleted succcessfully');
          _context2.next = 10;
          break;
        case 7:
          _context2.prev = 7;
  ...
  return function crossBooking(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
exports.crossBooking = crossBooking;
var updateBooking = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _axios.default.patch("http://127.0.0.1:8000/api/v1/bookings/edit-booking/".concat(id), data);
        case 3:
          result = _context3.sent;
          if (result.data.status === 'Success') {
            (0, _alerts.showAlert)('success', 'Booking updated Successfully!');
            window.setTimeout(function () {
  ...
  return function updateBooking(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();
...
var updateData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type, id) {
    var url, result, errString;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          if (type === 'Password') url = 'http://127.0.0.1:8000/api/v1/users/update-password';else if (type === 'Data') url = 'http://127.0.0.1:8000/api/v1/users/update-me';else if (type === 'adminData') url = "http://127.0.0.1:8000/api/v1/users/".concat(id);else if (type === 'adminPassword') url = "http://127.0.0.1:8000/api/v1/users/passwordUpdate/".concat(id);
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MpzyOGBjBj74gbshAy3sNmRXNH5fpI9PSynP3byxUDh0zwyCsQf0HSDZ0zkHkzh5SXjFI6P7xIIG9TdPxBTOa4s00Dxp1NtVT');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"usersManagement.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.crossUser = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var crossUser = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.delete("http://127.0.0.1:8000/api/v1/users/".concat(id));
        case 3:
          result = _context.sent;
          (0, _alerts.showAlert)('success', 'User deleted succcessfully');
          _context.next = 10;
          break;
        case 7:
          _context.prev = 7;
  ...
  return function crossUser(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.crossUser = crossUser;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"manageReviews.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateReview = exports.crossReview = exports.createReview = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var crossReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
    var result;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.delete("http://127.0.0.1:8000/api/v1/reviews/".concat(id));
        case 3:
          result = _context2.sent;
          if (result) (0, _alerts.showAlert)('success', 'Review deleted succcessfully');
          _context2.next = 10;
          break;
        case 7:
          _context2.prev = 7;
  ...
  return function crossReview(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
exports.crossReview = crossReview;
var updateReview = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _axios.default.patch("http://127.0.0.1:8000/api/v1/reviews/".concat(id), data);
        case 3:
          result = _context3.sent;
          if (result.data.status === 'Success') {
  ...
  return function updateReview(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();
...
var _manageBookings = require("./manageBookings");
var _updateData = require("./updateData");
var _stripe = require("./stripe");
var _usersManagement = require("./usersManagement");
var _axios = require("axios");
var _manageReviews = require("./manageReviews");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
// Users Management
var userEditForm = document.querySelector('.form-user-edit');
var userPasswordEditForm = document.querySelector('.form-user-edit-password');
// Tours Management
var createTourForm = document.querySelector('.form--create-tour');
var editTourForm = document.querySelector('.form--edit-tour');
var deleteTourBtn = document.querySelector('.btn--delete-tour');
var confirmTourDelete = document.querySelector('.btn--tour-confirm-delete');
// Bookings Management
var createBookingForm = document.querySelector('.form--create-booking');
var editBookingForm = document.querySelector('.form--edit-booking');
var deleteBookingBtn = document.querySelector('.btn--delete-booking');
var deleteBooking = document.querySelectorAll('.user__options__li--db');
var editBooking = document.querySelector('.btn--save-booking-data');
// Reviews Management
var deleteReview = document.querySelectorAll('.delete-container');
var deleteReviewBtn = document.querySelector('.btn--delete-review');
var editReviewForm = document.querySelector('.form--edit-review');
var createReviewForm = document.querySelector('.form--create-review');
// userEdits
...
var deleteUser = document.querySelectorAll('.user__options__li--du');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          data.startDates = [document.getElementById('date_1').value, document.getElementById('date_2').value, document.getElementById('date_3').value];
          data.startLocation = {};
          data.startLocation.type = 'Point';
          data.startLocation.coordinates = document.getElementById('start-location-coordinates').value.split(',');
          data.startLocation.description = document.getElementById('start-location-description').value;
          data.startLocation.address = document.getElementById('start-location-address').value;
          data.locations = [_defineProperty({
            type: 'point',
...
// Tour Edit
// A) Tour delete
if (deleteTourBtn) deleteTourBtn.addEventListener('click', function (e) {
  e.preventDefault();
  confirmDelete.classList.remove('hidden');
  overlay.classList.remove('hidden');
});
if (confirmTourDelete) {
  confirmTourDelete.addEventListener('click', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            _context3.next = 3;
            return (0, _manageTours.deleteTour)(e.target.dataset.id);
          case 3:
          case "end":
            return _context3.stop();
        }
...
// B) Tour Edit
if (editTourForm) editTourForm.addEventListener('submit', /*#__PURE__*/function () {
...
if (userEditForm) userEditForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          form.append('photo', document.getElementById('photo').files[0]);
          _context5.next = 9;
          return (0, _updateData.updateData)(form, 'adminData', id);
        case 9:
        case "end":
...
if (userPasswordEditForm) userPasswordEditForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
    var id, password, passwordConfirm;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          e.preventDefault();
          id = userPasswordEditForm.dataset.id;
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(e) {
...
if (logoutBtn) logoutBtn.addEventListener('click', _authenticate.logout);
/* eslint-disable */
if (deleteUser) deleteUser.forEach(function (de) {
...
if (deleteBtn) deleteBtn.addEventListener('click', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          _context8.next = 3;
          return (0, _usersManagement.crossUser)(id);
        case 3:
...
// Bookings Management
// A) Create booking
if (createBookingForm) createBookingForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          console.log(data);
          (0, _manageBookings.createBooking)(data);
        case 4:
        case "end":
...
if (deleteBooking) deleteBooking.forEach(function (de) {
  de.addEventListener('click', function (e) {
...
// B) Delete booking
if (deleteBookingBtn) deleteBookingBtn.addEventListener('click', /*#__PURE__*/function () {
  var _ref16 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(e) {
    var id;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          id = e.target.dataset.id;
          _context10.next = 3;
          return (0, _manageBookings.crossBooking)(id);
        case 3:
          document.getElementById(id).remove();
...
// C) Edit Booking
if (editBookingForm) editBookingForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          ...
          _context11.next = 5;
          return (0, _manageBookings.updateBooking)(id, data);
        case 5:
        case "end":
...
// Reviews management
// A) Delete Review
if (deleteReview) deleteReview.forEach(function (de) {
  de.addEventListener('click', function (e) {
    console.log('hello');
...
if (deleteReviewBtn) deleteReviewBtn.addEventListener('click', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        case 0:
          id = e.target.dataset.id;
          _context12.next = 3;
          return (0, _manageReviews.crossReview)(id);
        case 3:
          document.getElementById(id).remove();
...
// Edit Reveiw
if (editReviewForm) editReviewForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref19 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(e) {
    var id, review, rating;
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        case 0:
          e.preventDefault();
          id = editReviewForm.dataset.id;
          review = document.getElementById('review').value;
          rating = document.getElementById('rating').value;
          _context13.next = 6;
          return (0, _manageReviews.updateReview)(id, {
            review: review,
            rating: rating
          });
        case 6:
...
// Create review
if (createReviewForm) createReviewForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref20 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(e) {
    var tour, user, review, rating;
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        case 0:
          e.preventDefault();
          tour = createReviewForm.dataset.tour_id;
          user = createReviewForm.dataset.user_id;
          review = document.getElementById('review').value;
          rating = document.getElementById('rating').value;
          _context14.next = 7;
          return (0, _manageReviews.createReview)({
            tour: tour,
            user: user,
            review: review,
            rating: rating
