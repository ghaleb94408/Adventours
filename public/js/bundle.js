    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          data.locationDescription = document.getElementById('start-location-description').value;
          data.adress = document.getElementById('start-location-address').value;
          data.coordinates = document.getElementById('start-location-coordinates').value;
          data.startLocation = {
            description: document.getElementById('start-location-description').value,
            type: 'Point',
            coordinates: document.getElementById('start-location-coordinates').value.split(','),
            address: document.getElementById('start-location-address').value
          };
          data.imageCover = document.getElementById('photo').files[0];
          (0, _createTour.createTour)(data);
        case 17:
        case "end":
          return _context2.stop();
      }
